...
ENGINE = Table()
ROUTES = {
    "/insert": lambda payload: ENGINE.insert(payload["row"]),
    "/scan": lambda payload: ENGINE.scan(payload["column"], payload["value"]),
    "/encode": lambda payload: ENGINE.encode(),
    "/project": lambda payload: ENGINE.project(payload["columns"]),
